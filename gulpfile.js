...
function cV() {
    return src(path.src.cv)
        .pipe(dest(path.build.cv));
}
...
let build = gulp.series(clean, gulp.parallel(js, css, html, images, fonts, icons, cssSlick, jsSlick, scrollReveal, cV));
